...
if 1:
    ...
    torch.save(weights_pt, '../../Gs_karras2019stylegan-ffhq-1024x1024.pt')
if 1:
    # then on the PyTorch side run
    state_G, state_D, state_Gs = torch.load('../../Gs_karras2019stylegan-ffhq-1024x1024.pt')
    def key_translate(k):
        k = k.lower().split('/')
        if k[0] == 'g_synthesis':
    ...
    torch.save(g_all.state_dict(), '../../stylegan.pt')
